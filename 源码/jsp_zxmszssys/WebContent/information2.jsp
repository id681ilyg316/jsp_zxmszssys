	...
	<div class="team_xq_right">
		...
		<div class="team_xq_right_auto" style="display: block;">
			...
			<form style="width: 90%; height: 60%; center: center;" method="post"
				action="InforTwo" id="infor1">
				<input type="hidden" name="method" value="updateInfor">
				<ul>
					<li>尊敬的用户：<span style="color: #0089E1; font-size: 18px;">${cllent.ctel }
					</span>您好！
					</li>
					<hr />
					<li><label class="layui-form-label">姓名：</label><input
						type="text" name="cllName" class="infor"
						value="${cllent.cll_name}" onchange="upinfor1()"
						disabled="disabled"></li>
					<li><label class="layui-form-label">性别:</label> <select
						class="infor" name="csex" disabled="disabled"
						onchange="upinfor2()">
					...
					<li><label class="layui-form-label">标识码：</label><input
						...
						onchange="upinfor1()" disabled="disabled"></li>
					<li><label class="layui-form-label">年龄：</label><input
						type="text" name="age" id="age" class="infor"
						value="${cllent.age}" disabled="disabled"></li>

					<li><input type="button" class="button1" value="修改信息"
						onclick="bushow()" style="float: left; display: block;"> <input
						type="button" class="button1" onclick="update()" value="保存信息"
						onclick="update()" style="float: left; display: none;"> <input
		...
		<div class="team_xq_right_auto" style="display: none;">
			<form method="get" style="width: 90%; center: center;" id="infor2">
				<input type="text" name="method" value="updatePwd" hidden="hidden">
				<ul id="leaverss">
					<li>尊敬的用户：<span style="color: #0089E1; font-size: 18px;">${cllent.ctel }
					</span>您好！
					</li>
